...
export type InitializeJobAttack = {
  ...
  projectileSize: number | undefined,
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("projectileSpeed", AlgebraicType.createOptionType(AlgebraicType.createU32Type())),
      new ProductTypeElement("projectileSize", AlgebraicType.createOptionType(AlgebraicType.createU32Type())),
