...
import { LeaderboardUpdateTimer as __LeaderboardUpdateTimer } from "./leaderboard_update_timer_type";

export type UpdateLeaderboard = {
  timer: __LeaderboardUpdateTimer,
};
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      new ProductTypeElement("timer", __LeaderboardUpdateTimer.getTypeScriptAlgebraicType()),
    ]);
  }
