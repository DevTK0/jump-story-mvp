...
export function getDamageStyle(
  ...
  const colorTheme =
    DAMAGE_COLOR_THEMES[source][damageType as keyof (typeof DAMAGE_COLOR_THEMES)[typeof source]];
 ...
 */
export function getDamageTypeKey(damageType: DamageType): keyof typeof BASE_DAMAGE_STYLES {
