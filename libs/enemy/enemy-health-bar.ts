...
export class EnemyHealthBar {
    ...
    private drawHealthBar(): void {
        ...
        this.background.fillRoundedRect(-halfWidth, -halfHeight, config.width, config.height, config.cornerRadius);
        ...
        this.border.strokeRoundedRect(-halfWidth, -halfHeight, config.width, config.height, config.cornerRadius);
    }
