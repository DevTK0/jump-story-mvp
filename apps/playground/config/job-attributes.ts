...
const sharedAttacks = {
  ...
  attack3: {
    attackType: 'standard' as const,
    name: 'Combo Attack',
    description: 'A combo attack that deals massive damage.',
    damage: 15,
    cooldown: 0.5,
    critChance: 1,
    knockback: _knockback.meleeAttack3,
    range: 500,
    hits: 1,
    targets: 1,
    manaCost: 10,
  ...
  wizard: {
    ...
    attacks: {
      ...
      attack2: {
        ...
        cooldown: 0.8,
        critChance: 0.15,
        knockback: _knockback.rangedHeavyAttack2,
        range: 150,
        radius: 150,
        effectSprite: 'holy',
        hits: 1,
  ...
  archer: {
    ...
    attacks: {
      ...
      attack2: {
        ...
        cooldown: 0.8,
        critChance: 0.25,
        knockback: _knockback.rangedAttack2 * 2,
        range: 400,
        hits: 1,
        targets: 3,
        manaCost: 0,
      ...
      attack3: {
        ...
        cooldown: 1.2,
        critChance: 0.1,
        knockback: _knockback.rangedAttack3,
        range: 350,
        hits: 3,
        targets: 5,
        manaCost: 0,
